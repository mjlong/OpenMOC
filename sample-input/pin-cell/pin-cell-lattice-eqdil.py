...
uo21_id = materials['UO21'].getId()
uo22_id = materials['UO22'].getId()
uo23_id = materials['UO23'].getId()
...
cells = []
cells.append(CellBasic(universe=1, material=uo21_id,rings=int(sys.argv[2]), sectors=int(sys.argv[3])))
cells.append(CellBasic(universe=1, material=water_id))

cells.append(CellBasic(universe=2, material=uo22_id,rings=int(sys.argv[2]), sectors=int(sys.argv[3])))
cells.append(CellBasic(universe=2, material=water_id))

cells.append(CellBasic(universe=3, material=uo23_id,rings=int(sys.argv[2]), sectors=int(sys.argv[3])))
...
cells[4].addSurface(halfspace=-1, surface=circle)
cells[5].addSurface(halfspace=+1, surface=circle)
cells[6].addSurface(halfspace=-1, surface=circle)
cells[7].addSurface(halfspace=+1, surface=circle)

cells[8].addSurface(halfspace=+1, surface=left)
cells[8].addSurface(halfspace=-1, surface=right)
cells[8].addSurface(halfspace=+1, surface=bottom)
cells[8].addSurface(halfspace=-1, surface=top)
...
lattice = Lattice(id=5, width_x=1.26, width_y=1.26)
lattice.setLatticeCells([[2,1],[4,3]])
